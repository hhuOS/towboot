...
pub(super) fn parse_for_multiboot<A: Allocator>(info_builder: &mut InfoBuilder<A>) {
...
fn handle_acpi<A: Allocator>(table: &ConfigTableEntry, info_builder: &mut InfoBuilder<A>) {
...
fn handle_smbios<A: Allocator>(table: &ConfigTableEntry, info_builder: &mut InfoBuilder<A>) {
